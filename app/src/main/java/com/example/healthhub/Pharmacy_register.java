...
public class Pharmacy_register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (inputFullName.isEmpty() || inputPharmacyName.isEmpty() || inputUsername.isEmpty() ||
                    ...
                    Toast.makeText(Pharmacy_register.this, "Registration Failed - All fields must be filled", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    Toast.makeText(Pharmacy_register.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        loginRedirectText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Pharmacy_register.this, Pharmacy_login.class);
